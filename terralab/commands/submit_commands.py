...
from terralab.utils import process_json, handle_api_exceptions
...
@click.option("--inputs", type=str, help='JSON string input')
@click.option("--description", type=str, help='optional description for the job')
